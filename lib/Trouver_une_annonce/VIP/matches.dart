          ...
          SingleChildScrollView(
              child: Container(
                  ...
                  child: Stack(children: <Widget>[
                    ...
                    _buildCard(302, 26, 'Enzo', 'Viproom , Paris', false),
                    _buildCard(302, 213, 'Enzo', 'Viproom , Paris', false),
                    _buildCard(560, 213, 'Enzo', 'Viproom , Paris', false),
                    _buildCard(560, 26, 'Enzo', 'Viproom , Paris', false),
                    _buildCard(864, 26, 'Mehdi', 'Paris', true),
                    _buildCard(864, 213, 'Mehdi', 'Paris', true),
                    Positioned(
                        top: 148,
                        left: 40,
                        width: 330,
                        child: Text(
                          'Trouve un VIP à rejoindre pour profiter au maximum de la soirée',
...
Widget _buildCard(
    double top, double left, String name, String place, bool special) {
  return Positioned(
      top: top,
      left: left,
      child: Container(
